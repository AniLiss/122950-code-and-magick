...
function drawBar(ctx, i) {
  this.ctx = ctx;
  var columnHeight = 150;
  var columnWidth = 40;
  var stepX = 50;
  var stepY = 0;
  var newX = this.initialX + 35;
  var barColor;
  var redColor = 'rgba(255, 0, 0, 1)';

  var maxTime = Math.max.apply(null, this.times);
  stepY = columnHeight / maxTime;

  (this.names[i] === 'Вы') ? barColor = redColor : barColor = getRandomBlueColor();
